...
// MARK: - Extensions
extension FamilyDistributionBoxView {
    var distributonBoxView: some View {
        VStack(alignment: .leading) {
            if let distributions = store.value?.familyMemberDistribution {
                title
                
                horizontalGrid(distributions)
            }
        }
    }
    ...
    func horizontalGrid(_ distributions: [DashboardDistributionResponse]) -> some View {
